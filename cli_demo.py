...
DEFAULT_CKPT_PATH = '/Users/qiuyipeng/Desktop/博雅千章/LLaMA-Factory-main/saves/Gemma-2B-Chat/lora/train_2024-08-22-14-21-34'

_WELCOME_MSG = '''\
(欢迎使用 博雅千章 模型，输入内容即可进行对话，:h 显示命令帮助。)

(注：本演示受博雅千章的许可协议限制。我们强烈建议，用户不应传播及不应允许他人传播以下内容，包括但不限于仇恨言论、暴力、色情、欺诈相关的有害信息。)
'''
_HELP_MSG = '''\
Commands:
